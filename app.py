...
def add_person():
    ...
    db.session.commit()
    saved_person = {"id": new_person.id, "name": new_person.name}
    response = {
        "status": "success",
...
def get_person(user_id):
    ...
    response = {"status": "success", "data": existing_person}
...
def delete_person(user_id):
    ...
    response = {"status": "success", "message": "Person deleted successfully"}
    return jsonify(response), 200
